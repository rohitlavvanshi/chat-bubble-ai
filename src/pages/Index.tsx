      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
            Experience cutting-edge technology with our intelligent chatbot assistant. 
            Get instant help and personalized support 24/7.
          </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              Our intelligent chatbot provides instant, personalized assistance to help you achieve your goals faster.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center p-6">
              ...
              <p className="text-gray-600">Get instant answers to your questions with our lightning-fast AI assistant.</p>
            </div>
            ...
            <div className="text-center p-6">
              ...
              <p className="text-gray-600">Tailored responses based on your specific needs and preferences.</p>
            </div>
      ...
      <section className="py-16 bg-blue-600">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-blue-100 text-lg mb-8">
            Try our chatbot assistant now! Click the chat button in the bottom right corner.
          </p>
